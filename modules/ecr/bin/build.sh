...
# Connect into aws
$(aws ecr get-login-password --region us-west-2 | docker login --username AWS --password-stdin 293109864832.dkr.ecr.us-west-2.amazonaws.com || { echo 'ERROR: aws ecr login failed' ; exit 1; }
